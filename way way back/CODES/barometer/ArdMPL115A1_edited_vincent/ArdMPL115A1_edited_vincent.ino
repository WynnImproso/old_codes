...
void setup() {
    ...
    Serial.print("************************************************************************************\n\n");
    Serial.print("-----------------------------------------------------------------------------------------------------\n");
    Serial.print("|                       MPL115A1 Pressure Sensor                        |  LM35 Temperature Sensor  |\n");
}
...
void loop() {
    ...
    float temperatureC = (100 * reading) / 212;
    ...
    ///Serial.print(" kg/cm2 | ");
    Serial.print(pressure_pKa, 2);
    Serial.print(" kPa | ");
    
    // At a res of -5.35 counts/°C, digits lower than 0.1°C are not significant
    Serial.print(temperature_c, 2);
    Serial.print(" C | ");
    Serial.print(DEGC_TO_DEGF(temperature_c), 2);
    Serial.print(" F |   ");
    
    //read reading from sensorPin
    Serial.print(temperatureC, 2);
    Serial.print(" C   |   ");
    Serial.print(DEGC_TO_DEGF(temperatureC), 2);
    Serial.print(" F   | ");
    Serial.print(i);
    Serial.print("\n");
...
float calculateTemperatureC() {
    ...
    // 04:51pm S606
    // 05:35pm N601
    // 05:57pm 2nd Floor FT Building
    // 06:06pm PUP Clinic
    
    // January 24, 2014
    // 04:11pm Bartolay's House
    // return 25.77 + (q - 19.654) * 2/1;
    
    // calibrate PUP Lagoon
    // return 26.498 + (q - 20.44433) * 9/6;
    
    // calibrate CS Office
    //return 25.10183 + (q - 18.91517) * 21/13;
    
    // calibrate S606
    // return 25.43867 + (q - 19.5105) * 4/3;
    
    // calibrate N601
    // return 25.38383 + (q - 19.48867) * 14/12;
    
    // calibrate 2nd Floor FT Building
    // return 24.89033 + (q - 18.827) * 13/10;
    
    // calibrate PUP Clinic
    // return 25.45433 + (q - 19.627) * 0.994027;
    
     // January 27, 2014
     
     // calibrate E606
     // return 25.50133 + (q - 20.03417)* 2.429454164;
     // calibrate PUP Chapel
     // return 24.8355 + (q - 18.98517)*1.139354149;
   
    // ------------------------------------------------
    
    //calibrate 01: January 07 & 11 2014
    //return (1.145833)*(q - 21.4) + 27.06;
    
    //calibrate 02: January 13, 2014
    //return (78345498/99999999)*(q - 17.90) + 23.39;
    
    //calibrate 03: January 07 & 13, 2014
    //return (104857038/99999900)*(q - 17.90) + 23.39;
    
    //calibrate 04: January 11 & 13, 2014
    //return (82.8/99)*(q - 17.90) + 23.39;
    //February 3, 2014
                     
    return 27.901 + (q- 22.308)*0.603340649; 
}
